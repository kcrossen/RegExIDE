# RegExIDE
Regular Expression development environment, regex create, regex test, as compiled dmg for OS-X 10.11 (probably works on earlier OS-X) and source code. Although it only supports PCRE (8.39), it is otherwise essentially a superset of RegexBuddy (https://www.regexbuddy.com/). For example, RegExIDE has a trace feature that allows you to watch your RegEx in action as it parses your target text.
